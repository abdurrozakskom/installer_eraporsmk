...
echo -e "${YELLOW}• Lynk.id   : https://lynk.id/abdurrozak.skom${RESET}"
echo -e "${YELLOW}• Instagram : https://instagram.com/abdurrozak.skom${RESET}"
echo -e "${YELLOW}• Facebook  : https://facebook.com/abdurrozak.skom${RESET}"
echo -e "${YELLOW}• TikTok   : https://tiktok.com/abdurrozak.skom${RESET}"
echo -e "${YELLOW}• Threads   : https://threads.com/@abdurrozak.skom${RESET}"
echo -e "${YELLOW}• YouTube   : https://www.youtube.com/@AbdurRozakSKom${RESET}"
